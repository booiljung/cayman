...
네 가지 빌드 구성을 지원하며, 필요시 사용자 정의 빌드 구성을 정의할 수 있습니다.
...
이 변수를 지정하면 선택한 구성에 따라 컴파일 및 링크 옵션은 추가 합니다. 빌드 목적별로 빌드 스크립트를 각각 따로 작성하는 수고들 덜어 줍니다.
...
- type이 없으면 중요한 정보임을 나타내며, 구성을 계속 진행 합니다.
