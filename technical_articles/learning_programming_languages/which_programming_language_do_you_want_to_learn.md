...
Objective-C 언어는 과학기술계산용, 시스템 프로그램, 고성능 응용 프로그램 개발에 사용됩니다.
...
나쁜 언어 좋은 언어 구분은 좋지 않은 행동이며 그것을 의미가 없는 주장입니다. 언어마다 분야에 있어 강점과 약점이 있습니다. 첫 프로그래밍 언어를 선택할때 여러 언어 중 첫 프로그래밍 언어로 어떤 언어를 선택해야 할까요? 이미 여러분께서 적절한 언어를 선택 하셨으리라 생각 합니다.
