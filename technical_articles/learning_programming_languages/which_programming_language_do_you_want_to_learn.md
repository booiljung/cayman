...
다양한 언어로 `Hello, world!`를 출력하는 코드를 보겠습니다.
...
나쁜 언어 좋은 언어 구분은 이미가 없으며 좋지 않은 습관이라고 봅니다. 언어마다 강점가 약점이 있습니다. 여러 언어 중 첫 프로그래밍 언어로 어떤 언어가 좋을까요? 여러분께서 적절한 언어를 선택 하셨으리라 생각 합니다.